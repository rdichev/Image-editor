      ...
      <main className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden min-h-[500px] flex flex-col">
            ...
            <div className="flex-1 relative flex items-center justify-center bg-gray-50/50 p-8 group">
              ...
              {image.original && !image.edited && status !== EditStatus.PROCESSING && (
                <div className="relative w-full h-full flex items-center justify-center">
                  ...
                  />
                  <div className="absolute top-4 left-4 px-3 py-1 bg-white/80 backdrop-blur rounded-full text-[10px] font-bold text-gray-600 shadow-sm border border-white/40">
                    ORIGINAL
                  </div>
                </div>
              )}
              ...
              {image.edited && (
                <div className="relative w-full h-full flex flex-col items-center justify-center gap-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full h-full p-4">
                     <div className="relative flex items-center justify-center bg-gray-100 rounded-xl overflow-hidden group">
                        <img 
                          src={image.original} 
                          alt="Before" 
                          className="max-w-full max-h-[400px] object-contain" 
                        />
                        <div className="absolute bottom-2 left-2 px-2 py-1 bg-black/50 text-white text-[10px] font-bold rounded">BEFORE</div>
                     </div>
                     <div className="relative flex items-center justify-center bg-gray-100 rounded-xl overflow-hidden">
                        ...
                        />
                        <div className="absolute bottom-2 left-2 px-2 py-1 bg-indigo-600 text-white text-[10px] font-bold rounded">AFTER (AI REFINED)</div>
                     </div>
                  </div>
                </div>
              )}
